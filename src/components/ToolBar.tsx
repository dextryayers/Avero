...
const tools: { id: ToolId; icon: any; label: string; shortcut: string }[] = [
  ...
  { id: "select-rect", icon: MousePointer2, label: "Rect Select (M ganti ellipse)", shortcut: "M" },
  { id: "select-ellipse", icon: CircleDashed, label: "Ellipse Select (M)", shortcut: "M" },
  ...
  { id: "clone", icon: Stamp, label: "Clone Stamp (Alt+klik sumber)", shortcut: "S" },
  { id: "eyedropper", icon: Pipette, label: "Eyedropper", shortcut: "I" },
  { id: "text", icon: Type, label: "Text", shortcut: "T" },
  { id: "shape-rect", icon: Square, label: "Shape Rect (U ganti)", shortcut: "U" },
  { id: "shape-ellipse", icon: Circle, label: "Shape Ellipse (U)", shortcut: "U" },
  { id: "shape-polygon", icon: Hexagon, label: "Shape Polygon (U)", shortcut: "U" },
